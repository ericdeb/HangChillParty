		...
		var appendLI = function(x,i) {
			...
			$('<li style="display:none;">'
				+ (op.show_avatar? '<span class="rrt-author-img">'
									+'<a target="_blank" href="http://twitter.com/'+ x.from_user +'" title="'+ x.from_user +'">'
				...
				+'<span class="rrt-body">'
					...
					+'<span class="rrt-meta">'
						+ (op.show_date? '<a target="_blank" class="rrt-date" href="http://twitter.com/'+ x.from_user +'/status/'+ x.id +'">'
